<?php
/*******************************************************************************
**  The English language file for Remository 3.20+ until further notice
**
...
if (!defined('_DOWN_MAIL_MSG')) define('_DOWN_MAIL_MSG','Hello a new user Downloads submission has been submitted by $user_full for the $mosConfig_sitename website.\nPlease go to $mosConfig_live_site/administrator/index.php as an admin to view and approve this submission.\n\nPlease do not respond to this message as it is automatically generated and is for information purposes only\n');
if (!defined('_DOWN_MAIL_MSG_APP')) define('_DOWN_MAIL_MSG_APP','Hello a new user Downloads submission has been submitted by $user_full for the $mosConfig_sitename website.\nIn accordance with the configuration options, it has been auto-appproved.\n\nPlease do not respond to this message as it is automatically generated and is for information purposes only\n');
...
if (!defined('_DOWN_MEMBER_ONLY_WARN')) define('_DOWN_MEMBER_ONLY_WARN','This location is for Group Members Only.<BR />Please refer to admin concerning group ');
if (!defined('_DOWN_REG_ONLY_WARN')) define('_DOWN_REG_ONLY_WARN',"This location is for Registered Users Only.<BR />Please login or <a href='index.php?option=com_registration&task=register'>Register</a>.");
...
if (!defined('_DOWN_CONFIG_ERR')) define('_DOWN_CONFIG_ERR','An Error Has Occurred! Unable to open config file to write!');
