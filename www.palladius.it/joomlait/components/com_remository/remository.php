...
if(file_exists('components/com_remository/language/'.$mosConfig_lang.'.php')) require_once('components/com_remository/language/'.$mosConfig_lang.'.php');
else require_once('components/com_remository/language/english.php');
...
{
	if (remositoryRepository::getParam($_POST,'submit_vote',0)) {
	...
	if (remositoryRepository::getParam($_POST,'submit_comm',0)) {
...
function search ( &$remUser, &$repository )
{
	...
	if (remositoryRepository::getParam($_POST,'submit',0)) {
		...
		$file_array = $repository->searchRepository($search_text, $seek_title, $seek_desc, $remUser, $repository);
