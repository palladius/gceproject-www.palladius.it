...
class remositoryFile extends remositoryAbstract {
	...
	*/
	...
	function searchFilesSQL($search_text, $seek_title, $seek_desc, &$user, &$repository) {
...
class remositoryRepository extends remositoryAbstract {
	...
	function searchRepository($search_text, $seek_title, $seek_desc, &$user, &$repository) {
		$sql = remositoryFile::searchFilesSQL($search_text, $seek_title, $seek_desc, $user, $repository);
