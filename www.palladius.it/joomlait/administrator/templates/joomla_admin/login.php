	...
	<div class="login">
		<div class="login-form">
			...
			<div class="form-block">
				...
				<div align="left"><input type="submit" name="submit" class="button" value="Invia" /></div>
			</div>
			</form>
		</div>
		<div class="login-text">
			<div class="ctr"><img src="templates/joomla_admin/images/security.png" width="64" height="64" alt="Sicurezza" /></div>
			<p>Benvenuto in Joomla!</p>
			<p>Usa validi username e password per garantirti l&acute;accesso al pannello amministrativo.</p>
		</div>
		<div class="clr"></div>
	</div>
</div>
<div id="break"></div>
<noscript>
!Attenzione! Javascript deve essere abilitato per effettuare le operazioni di amministrazione
</noscript>
