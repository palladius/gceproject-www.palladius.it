	...
	*/
	...
	function system_info( $version ) {
		...
		?>
			...
			<tr>
				<td>
					<strong>Versione database:</strong>
				</td>
				<td>
			...
			<tr>
				...
				<td>
					...
					<tr>
						<td width="250">
							Joomla! Emulazione Register Globals:
						</td>
					...
					<tr>
						...
						<td style="font-weight: bold;" colspan="2">
							<?php echo (($sp=ini_get('session.save_path'))?$sp:'nessuna'); ?>
						</td>
					</tr>
					<tr>
						<td>
					...
					<tr>
						...
						<td style="font-weight: bold;" colspan="2">
							<?php echo (($ob = ini_get('open_basedir')) ? $ob : 'nessuna'); ?>
						</td>
					</tr>
					<tr>
						<td>
					...
					<tr>
						...
						<td style="font-weight: bold;" colspan="2">
							<?php echo (($df=ini_get('disable_functions'))?$df:'nessuna'); ?>
						</td>
					</tr>
					</table>
				</td>
		...
		?>
			...
			<tr>
				<td>
					<strong>Per utilizzare al meglio tutte le funzioni e le caratteristiche di Joomla! le seguenti directory devono essere scrivibili:</strong>
					<?php
					...
					mosHTML::writableCell( $mosConfig_cachepath, 0, '<strong>Cartella Cache</strong> ' );
					mosHTML::writableCell( $sp, 0, '<strong>Cartella Sessione</strong> ' );
					?>
				</td>
			</tr>
			</table>
				...
				<table width="100%">
					<tr>
						<td>
							...
							<input type="button" value="Resetta risultati" class="button" onclick="f=document.adminForm;f.helpsearch.value='';f.submit()" />
							</td>
