...
class HTML_menusections {
	...
	function showMenusections( $rows, $pageNav, $search, $levellist, $menutype, $option ) {
		...
		<tr>
			<th class="menus">
			Gestione menu <small><small>[ <?php echo $menutype;?> ]</small></small>
			</th>
			<td nowrap="nowrap">
			Livelli massimi
			</td>
	...
	*/
	function addMenuItem( &$cid, $menutype, $option, $types_content, $types_component, $types_link, $types_other, $types_submit ) {
		...
		<tr>
			...
			* Nota bene che alcuni tipi menu appaiono in pi&ugrave; di un gruppo, ma sono dello stesso tipo menu.
			</td>
		</tr>
		</table>
	...
	*/
	function moveMenu( $option, $cid, $MenuList, $items, $menutype  ) {
		...
		<tr>
			...
			<strong>
			Voci di menu in fase di spostamento:
			</strong>
			<br />
			<ol>
			<?php
