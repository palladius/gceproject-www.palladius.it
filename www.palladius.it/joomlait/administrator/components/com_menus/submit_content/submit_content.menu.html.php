	...
	function edit( &$menu, &$lists, &$params, $option ) {
		...
		function submitbutton(pressbutton) {
			...
			if ( !$menu->id ) {
				...
				?>
				if ( form.name.value == '' ) {
					alert( 'Questo menu deve avere un titolo' );
				} else {
					submitform( pressbutton );
				}
				<?php
		...
		<tr>
			<th>
			<?php echo $menu->id ? 'Modifica' : 'Aggiungi';?> Voce di menu :: Invia - Contenuto
			</th>
		</tr>
		</table>
		...
		<tr valign="top">
			<td width="60%">
				...
				<tr>
					...
					<?php
					if ( !$menu->id ) {
						echo mosToolTip( 'se lasciato vuoto prende in automatico il nome della sezione' );
					}
					?>
					</td>
				</tr>
