	...
	function edit( &$menu, &$lists, &$params, $option ) {
		...
		function submitbutton(pressbutton) {
			...
			if ( trim(form.name.value) == "" ){
				alert( "Il cllegamento deve avere un nome" );
			} else if ( trim( form.link.value ) == "" ){
				alert( "Dovete selezionare un componente da collegare" );
			} else {
				submitform( pressbutton );
			}
		}
		...
		<tr>
			<th>
			<?php echo $menu->id ? 'Modifica' : 'Aggiungi';?> Voce di menu :: Collegamento - Componente
			</th>
		</tr>
		</table>
