...
class HTML_contact {
		...
		for ($i=0, $n=count($rows); $i < $n; $i++) {
			...
			<tr class="<?php echo "row$k"; ?>">
				...
				if ( $row->checked_out && ( $row->checked_out != $my->id ) ) {
					...
					?>
					<a href="<?php echo $link; ?>" title="Modifica contatto">
					<?php echo $row->name; ?>
					</a>
					<?php
				}
				...
				<td>
				<a href="<?php echo $row->user_link; ?>" title="Modifica utente">
				<?php echo $row->user; ?>
				</a>
				</td>
			</tr>
	...
	function editContact( &$row, &$lists, $option, &$params ) {
		...
		<tr>
			<th>
			<?php echo $row->id ? 'Modifica: ' : 'Nuovo: ';?> Contatto
			</th>
		</tr>
		</table>
		...
		<tr>
			...
			<td width="40%" valign="top">
				...
				<tr>
					...
					document.write('<img src=' + jsimg + ' name="imagelib" width="100" height="100" border="2" alt="Anteprima" />');
					</script>
					</td>
				</tr>
				</table>
				...
				<tr>
					<td>
					* Con questi parametri controlliamo solo ci&ograve; che viene vogliamo venga visualizzato quando un utente clicca sul contatto *
					<br /><br />
					</td>
				</tr>
				<tr>
