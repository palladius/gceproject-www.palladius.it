...
class HTML_languages {
	...
	function showLanguages( $cur_lang, &$rows, &$pageNav, $option ) {
		...
		<tr>
			...
			Gestione lingua <small><small>[ Sito ]</small></small>
			</th>
		</tr>
		</table>
	...
	function editLanguageSource( $language, &$content, $option ) {
		...
		<tr>
			<td width="270"><table class="adminheading"><tr><th class="langmanager">Editor lingua</th></tr></table></td>
			<td width="240">
				<span class="componentheading"><?php echo $language; ?>.php is :
				<b><?php echo is_writable($language_path) ? '<font color="green"> Scrivibile</font>' : '<font color="red"> Non scrivibile</font>' ?></b>
				</span>
			</td>
<?php
