...
HTML_installer::showInstallForm( 'Installa nuovo Modulo', $option, 'module', '', dirname(__FILE__) );
?>
<table class="content">
<?php
writableCell( 'media' );
...
function showInstalledModules( $_option ) {
	...
	$select[] 		= mosHTML::makeOption( '', 'Tutti' );
	$select[] 		= mosHTML::makeOption( '0', 'Modulo sito' );
	$select[] 		= mosHTML::makeOption( '1', 'Modulo admin' );
