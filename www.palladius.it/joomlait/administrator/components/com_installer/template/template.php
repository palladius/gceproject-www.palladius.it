...
HTML_installer::showInstallForm( 'Installa nuovo Template <small><small>[ ' . ($client == 'admin' ? 'Amministratore' : 'Sito') .' ]</small></small>',
	$option, 'template', $client, $userfile,
	'<a href="index2.php?option=com_templates&client='.$client.'">Indietro ai template</a>'
);
?>
<table class="content">
<?php
