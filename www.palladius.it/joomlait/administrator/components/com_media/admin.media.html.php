...
class HTML_Media {
							...
							<tr>
								...
								<td class="buttonOut" width="10">
									<a href="javascript:dirup()">
										<img src="components/com_media/images/btnFolderUp.gif" width="15" height="15" border="0" alt="Su" />
									</a>
								</td>
								<td align="right">
									Caricamento file <small>[ Max = <?php echo ini_get( 'post_max_size' );?> ]</small>
									&nbsp;&nbsp;&nbsp;&nbsp;
		...
		<tr>
			<td>
				<div align="center" style="font-size:small;font-weight:bold;color:#CC0000;font-family: Helvetica, sans-serif;">
					Problema di configurazione: &quot;<?php echo $BASE_DIR.$BASE_ROOT; ?>&quot; non esiste.
				</div>
			</td>
		</tr>
		</table>
	...
	function show_image($img, $file, $info, $size, $listdir) {
		...
		$overlib .= '</tr>';
		$overlib .= '</table>';
		$overlib .= '<br/> *Clicca per ingrandire*';
		$overlib .= '<br/> *Clicca per il codice immagine*';
		?>
		<div style="float:left; padding: 5px">
			...
			<div class="imginfoBorder">
				...
				<div class="buttonOut">
					<a href="index2.php?option=com_media&amp;task=delete&amp;delFile=<?php echo $file; ?>&amp;listdir=<?php echo $listdir; ?>" target="_top" onclick="return deleteImage('<?php echo $file; ?>');" title="Cancella oggetto">
						<img src="components/com_media/images/edit_trash.gif" width="15" height="15" border="0" alt="Cancella" /></a>
					<a href="#" onclick="javascript:window.top.document.forms[0].imagecode.value = '<img src=&quot;<?php echo $img_url_link;?>&quot; align=&quot;left&quot; hspace=&quot;6&quot; alt=&quot;Image&quot; />';" title="Codice immagine">
						<img src="components/com_media/images/edit_pencil.gif" width="15" height="15" border="0" alt="Codice" /></a>
				</div>					
			</div>
		</div>
		<?php
	...
	function show_doc($doc, $size, $listdir, $icon) {
		...
		$overlib = 'Ampiezza: '. $size;
		$overlib .= '<br/><br/> *Clicca per la URL*';
		?>
		<div style="float:left; padding: 5px">
	...
	function imageStyle($listdir) {
		...
		function deleteFolder(folder, numFiles) {
			if(numFiles > 0) {
				alert("Ci sono "+numFiles+" file/cartelle in \""+folder+"\".\n\nCancellare prima tutti i file/cartelle in \""+folder+"\".");
				return false;
			}

			if(confirm("Cancella cartella \""+folder+"\"?"))
			return true;
