	...
	*/
	function edit( &$row, $option, &$lists, &$menus ) {
		...
		function submitbutton(pressbutton) {
			...
			if ( pressbutton == 'menulink' ) {
				if ( form.menuselect.value == "" ) {
					...
					alert( "Selezionare un tipo menu" );
					return;
				} else if ( form.link_name.value == "" ) {
					alert( "Inserire il nome per questa voce di menu" );
					return;
				}
			}

			if (form.name.value == ""){
				alert("La sezione deve avere un nome");
			} else if (form.title.value ==""){
				alert("La sezione deve avere un titolo");
			} else {
		...
		<tr>
			<th class="sections">
			<small>
			<?php echo $row->id ? 'Modifica' : 'Nuova';?>: Sezione
			</small>
			<small><small>
		...
		<tr>
			<td valign="top" width="60%">
				...
				<tr>
					...
					<td colspan="2">
					<input class="text_area" type="text" name="title" value="<?php echo $row->title; ?>" size="50" maxlength="50" title="Un nome corto che appare nel menu" />
					</td>
				</tr>
				<tr>
					<td>
					<?php echo (isset($row->section) ? "Categoria" : "Sezione");?> Nome:
					</td>
					<td colspan="2">
					<input class="text_area" type="text" name="name" value="<?php echo $row->name; ?>" size="50" maxlength="255" title="Un titolo lungo che appare nelle intestazioni" />
					</td>
				</tr>
				<tr>
					<td>
				...
				<tr>
					...
					?>
					<img src="<?php echo $path;?><?php echo $row->image;?>" name="imagelib" width="80" height="80" border="2" alt="Anteprima" />
					</td>
				</tr>
				<tr>
					<td>
			...
			if ( $row->id > 0 ) {
				...
				<tr>
					<td colspan="2">
					Questo crea un collegamento con una voce di menu al menu selezionato
					<br /><br />
					</td>
				<tr>
				<tr>
	...
	*/
	function copySectionSelect( $option, $cid, $categories, $contents, $section ) {
		...
		<tr>
			...
			<strong>Copia alla sezione:</strong>
			<br />
			<input class="text_area" type="text" name="title" value="" size="35" maxlength="50" title="nome nuova sezione" />
			<br /><br />
			</td>
			...
			<td valign="top">
			Questo copia le categorie listate
			<br />
			e tutti gli oggetti contenuti (listati ache quelli)
			<br />
			nella nuova sezione.
			</td>.
		</tr>
