...
function com_install(){
	...
	if (@mkdir ($mosConfig_absolute_path."/images/zoom", 0755) || is_dir($mosConfig_absolute_path."/images/zoom")) {
    	@chmod ($mosConfig_absolute_path."/images/zoom", 0755);
    	@chmod ($mosConfig_absolute_path."/components/com_zoom/etc/audiolist.php", 0755);
    	@chmod ($mosConfig_absolute_path."/components/com_zoom/etc/safemode.php", 0755);
    	@chmod ($mosConfig_absolute_path."/components/com_zoom/etc/zoom_config.php", 0755);
		...
		if (@mkdir ($mosConfig_absolute_path."/images/zoom/watermarks", 0755) || is_dir($mosConfig_absolute_path."/images/zoom/watermarks")) {
    		@chmod ($mosConfig_absolute_path."/images/zoom/watermarks", 0755);
    		echo ('<font color="green">' . '&nbsp;' . _ZOOM_INSTALL_CREATE_DIR_SUCC . '</font></p>');
		} else {
