	...
	*/
	function showList( $option, $content, $pageNav, $list, $catid ) {
		...
		*/
		...
		<tr>
			<th class="trash">Gestione cestino</th>
			<td width="right">
				<?php echo $list; ?>
			</td>
		</tr>
		...
		<tr>
			...
			<th>
			<?php echo ($catid=="content") ? "Menu" : "Sezione"; ?>
			</th>
			<th>
			<?php echo ($catid=="content") ? "Tipo" : "Categoria"; ?>
			</th>
			<th width="70px">
			ID
			</th>
	...
	*/
	...
	?>
		...
		<tr>
			...
			<strong>Numero di oggetti:</strong>
			<br />
			<font color="#000066"><strong><?php echo count( $cid ); ?></strong></font>
			<br /><br />
			</td>
			<td align="left" valign="top" width="25%">
			<strong>Oggetti in fase di cancellazione:</strong>
			<br />
			<?php
			echo "<ol>";
			...
			?>
			 ...
			 <td valign="top">
			* Questa funzione cancella <strong><font color="#FF0000">Permanentemente</font></strong> <br />questi oggetti dal database *
			<br /><br /><br />
			<div style="border: 1px dotted gray; width: 70px; padding: 10px; margin-left: 50px;">
			<a class="toolbar" href="javascript:if (confirm('Sei certo di voler cancellare gli oggetti indicati nella lista? \nQuesta funzione cancella permanentemente questi oggetti dal database.')){ submitbutton('delete');}" onmouseout="MM_swapImgRestore();"  onmouseover="MM_swapImage('remove','','images/delete_f2.png',1);">
	...
	*/
	...
	?>
		...
		<tr>
			...
			<td align="left" valign="top" width="25%">
			<strong>Oggetti in fase di ripristino:</strong>
			<br />
			<?php
			echo "<ol>";
			foreach ( $items as $item ) {
			...
			?>
			 ...
			 <td valign="top">
			* Questa funzione <strong><font color="#FF0000">Ripristina</font></strong> questi oggetti,<br /> che torneranno nella loro posizione originaria come oggetti non pubblicati *
			<br /><br /><br />
			<div style="border: 1px dotted gray; width: 80px; padding: 10px; margin-left: 50px;">
			<a class="toolbar" href="javascript:if (confirm('Sei certo di voler ripristinare gli oggetti indicati nella lista?.')){ submitbutton('restore');}" onmouseout="MM_swapImgRestore();"  onmouseover="MM_swapImage('restore','','images/restore_f2.png',1);">
			<img name="restore" src="images/restore.png" alt="Ripristina" border="0" align="middle" />
			&nbsp;Ripristina
			</a>
			</div>
			</td>
