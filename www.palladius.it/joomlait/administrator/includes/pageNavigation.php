	...
	*/
	function getPagesLinks() {
		...
		if ($this_page < $total_pages) {
			...
			$html .= "\n<a href=\"#next\" class=\"pagenav\" title=\"pagina seguente\" onclick=\"javascript: document.adminForm.limitstart.value=$page; document.adminForm.submit();return false;\"> Seguente&nbsp;&gt;</a>";
			$html .= "\n<a href=\"#end\" class=\"pagenav\" title=\"ultima pagina\" onclick=\"javascript: document.adminForm.limitstart.value=$end_page; document.adminForm.submit();return false;\"> Fine&nbsp;&gt;&gt;</a>";
		} else {
			$html .= "\n<span class=\"pagenav\">Seguente&nbsp;&gt;</span>";
	...
	function getListFooter() {
		...
		$html .= '</th></tr><tr>';
		$html .= '<td nowrap="nowrap" width="48%" align="right">Mostra #</td>';
