	...
	*/
	...
	function check() {
		...
		if ($xid && $xid != intval( $this->id )) {
			$this->_error = "Ci sono già categorie con questo nome, riprova.";
			return false;
		}
		return true;
	}
...
class mosSection extends mosDBTable {
	...
	*/
	...
	function check() {
		...
		$xid = intval( $this->_db->loadResult() );
		if ($xid && $xid != intval( $this->id )) {
			$this->_error = "Abbiamo già una sezione con questo nome, riprova.";
			return false;
		}
		return true;
	}
...
class mosModule extends mosDBTable {
	...
	*/
	...
	function check() {
		...
		//$xid = intval( $this->_db->loadResult() );
		//if ($xid && $xid != intval( $this->id )) {
		//	$this->_error = "Esiste in archivio un modulo con questo nome, riprova.";
		//	return false;
		//}
		return true;
	}
