...
class mosMenuBar {
	...
	*/
	function preview( $popup='', $updateEditors=false ) {
		global $database;
		$image2 = mosAdminMenus::ImageCheckAdmin( 'preview_f2.png', '/administrator/images/', NULL, NULL, 'Anteprima', 'preview', 1, 'middle', 'Preview' );
	...
	*/
	function help( $ref, $com=false ) {
		...
		$image2 	= mosAdminMenus::ImageCheckAdmin( 'help_f2.png', '/administrator/images/', NULL, NULL, 'Aiuto', 'help', 1, 'middle', 'Help' );
