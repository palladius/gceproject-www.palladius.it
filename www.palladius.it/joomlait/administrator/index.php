...
if (isset( $_POST['submit'] )) {
	...
	if($pass == NULL) {
		echo "<script>alert('Inserire una password'); document.location.href='index.php?mosmsg=Si prega inserire una password'</script>\n";
		exit();
	} else {
		$pass = md5( $pass );
	}
	...
	if (@$my->id) {
		...
		mosErrorAlert("Username e Password non corrette, riprova", "document.location.href='index.php?mosmsg=Username e Password non corrette, riprova'");
	}
} else {
	initGzip();
