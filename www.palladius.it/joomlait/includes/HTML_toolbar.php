...
class mosToolBar {
	...
	*/
	function custom( $task='', $icon=NULL, $iconOver='', $alt='', $listSelect=true ) {
		if ($listSelect) {
			$href = "javascript:if (document.adminForm.boxchecked.value == 0){ alert('Selezionare un oggetto dalla lista da $alt');}else{submitbutton('$task')}";
		} else {
	...
	*/
	function publishList( $task='publish', $alt=_CMN_PUBLISHED ) {
		...
		?>
		<td>
			<a class="toolbar" href="javascript:if (document.adminForm.boxchecked.value == 0){ alert('Selezionare un oggetto dalla lista da pubblicare'); } else {submitbutton('<?php echo $task;?>', '');}" >
				<?php echo $image; ?></a>
		</td>
		<?php
	}
	...
	*/
	function unpublishList( $task='unpublish', $alt=_CMN_UNPUBLISHED ) {
		...
		?>
		<td>
			<a class="toolbar" href="javascript:if (document.adminForm.boxchecked.value == 0){ alert('Selezionare un oggetto dalla lista da sospendere'); } else {submitbutton('<?php echo $task;?>', '');}" >
				<?php echo $image; ?></a>
		</td>
		<?php
	}
	...
	*/
	function archiveList( $task='archive', $alt=_CMN_ARCHIVE ) {
		...
		?>
		<td>
			<a class="toolbar" href="javascript:if (document.adminForm.boxchecked.value == 0){ alert('Selezionare un oggetto dalla lista da archiviare'); } else {submitbutton('<?php echo $task;?>', '');}" >
				<?php echo $image; ?></a>
		</td>
		<?php
	}
	...
	*/
	function unarchiveList( $task='unarchive', $alt=_CMN_UNARCHIVE ) {
		...
		?>
		<td>
			<a class="toolbar" href="javascript:if (document.adminForm.boxchecked.value == 0){ alert('Selezionare un oggetto dalla lista da ripristinare'); } else {submitbutton('<?php echo $task;?>', '');}" >
				<?php echo $image; ?></a>
		</td>
		<?php
	}
	...
	*/
	function editList( $task='edit', $alt=_E_EDIT ) {
		...
		?>
		<td>
			<a class="toolbar" href="javascript:if (document.adminForm.boxchecked.value == 0){ alert('Selezionare un oggetto dalla lista da modificare'); } else {submitbutton('<?php echo $task;?>', '');}" >
				<?php echo $image; ?></a>
		</td>
		<?php
	}
	...
	*/
	function deleteList( $msg='', $task='remove', $alt=_CMN_DELETE ) {
		...
		?>
		<td>
			<a class="toolbar" href="javascript:if (document.adminForm.boxchecked.value == 0){ alert('Selezionare un oggetto dalla lista da cancellare'); } else if (confirm('Sei sicuro di voler cancellare gli elementi selezionati?. <?php echo $msg;?>')){ submitbutton('<?php echo $task;?>');}" >
				<?php echo $image; ?></a>
		</td>
		<?php
	}
	...
	*/
	function preview( $popup='' ) {
		...
		$image = mosAdminMenus::ImageCheck( 'preview_f2.png', 'images/', NULL, NULL, 'Anteprima', 'preview', 1 );
		?>
		<td>
	...
	*/
	function savenew() {
		$image = mosAdminMenus::ImageCheck( 'save_f2.png', '/images/', NULL, NULL, 'salva', 'save', 1 );
		?>
		<td>
	...
	*/
	function back() {
		$image = mosAdminMenus::ImageCheck( 'back_f2.png', '/images/', NULL, NULL, 'indietro', 'cancel', 1 );
		?>
		<td>
	...
	*/
	function media_manager( $directory = '' ) {
		$image = mosAdminMenus::ImageCheck( 'upload_f2.png', '/images/', NULL, NULL, 'Carica immagine', 'uploadPic', 1 );
		?>
		<td>
