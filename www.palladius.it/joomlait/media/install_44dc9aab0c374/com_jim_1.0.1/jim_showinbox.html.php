...
?>
		<tr class="sectiontableentry<?php echo $k+1; ?>">
			...
			<td>
				<a href="index.php?option=com_jim&task=view&id=<?php echo $row->id?>" /><?php echo $subject?></a>
			</td>
			<td>
<?php
...
<?php
	...
	echo $pageNav->writePagesLinks("index.php?option=com_jim&amp;page=inbox");
	echo "<br>";
	echo $pageNav->writeLimitBox("index.php?option=com_jim&amp;page=inbox");
?>
			</td>
		</tr>
