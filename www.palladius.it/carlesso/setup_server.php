...
$dbusuario="Palladius";     		# user del database
$dbpassword="iPsCIFai9";	       	# password del database
$db="goliardia";	      	# nome del database
$DOVE_SONO="Buddhome";		# dove è il server, a scopi mnemonici (x non confondere locale con remoto...)
$db = "palladius";
#=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=- personalizzazioni
